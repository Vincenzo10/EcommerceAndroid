...
//lettura userId dalle sharedpreferebces, se esiste vado alla main activity Intent...
...
//            }
        ...
        protected void onPostExecute(final User success) {
            ...
            if (success != null) {
                ...
                Intent i = new Intent(LoginNewActivity.this, MainActivity.class);

                //salvataggio userId nelle sharedprefer....
